...
export const PSHAView: React.FC<PSHAViewProps> = ({ scenario, faults }) => {
  return (
    <div className="flex flex-col space-y-4">
      {/* Overview Banner */}
      <div className="rounded-xl border border-slate-800 bg-slate_obsidian-card p-4 flex flex-col md:flex-row items-start md:items-center justify-between gap-4">
        <div>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-12 gap-4">
        ...
        <div className="lg:col-span-7 h-[500px] rounded-xl border border-slate-800 overflow-hidden shadow-xl bg-slate_obsidian-900 relative isolate">
          <GisMap
            faults={faults}
            scenario={scenario}
            selectedFaultId={2}
